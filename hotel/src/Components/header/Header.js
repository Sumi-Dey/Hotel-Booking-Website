  ...
  return (
    <div className='header'>
      ...
      <div className='searchItems'>
        ...
        <div className='searchProducts'  onClick={() => setOpendates(!opendates)}>
          <BsFillCalendarFill  className='header-icon' />
        ...
        <div className='searchProducts' onClick={()=>setOpenOptions(!openOptions)}>
          <GiPerson  className='header-icon'  />
